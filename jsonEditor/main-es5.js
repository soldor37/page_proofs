...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppJsonInputJsonInputComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    JsonInputComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 17,
      vars: 1,
      consts: [[1, "card", "border-0"], [1, "page__title"], [1, "jsonInput-form", "input-group"], [1, "input-group-prepend"], [1, "input-group-text"], ["aria-label", "JSON input", "placeholder", "Put your JSON text here...\nExample:\n[\n    {\n    'name': 'Alex',\n    'year' : '2001',\n    'country' : 'Russia'\n    },\n    {\n    'name' : 'George',\n    'year' : '2002',\n    'country' : 'China'\n    },\n    {\n    'name' : 'Julia',\n    'year' : '2003',\n    'country' : 'Japan'\n    }\n]", 1, "jsonInput-form__input", "form-control", 3, "ngModel", "ngModelChange"], [1, "custom-file"], ["type", "file", "id", "inputGroupFile01", 1, "custom-file-input", 3, "change"], ["for", "inputGroupFile01", 1, "custom-file-label"], ["role", "alert", "id", "alertInput", 1, "alert", "alert-danger", "show"], ["type", "button", 1, "inputJson-form__submit", "btn", "btn-primary", 3, "click"]],
